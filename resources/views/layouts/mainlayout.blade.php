            ...
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
                ...
                <div>
                    <a class="navbar-brand brand-logo" href="/dashboard">
                        <p style="padding: 0;margin-bottom: 3px; font-size: 1em; font-weight:bold; color:blue">@yield('title')</p>
                    </a>
                </div>
            </div>
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item fw-semibold d-none d-lg-block ms-0">
                        <h2 class=" text-dark m-0">Hello there, sir <span class="text-dark font-weight-bold m-0" style="font-weight:bold">{{ auth()->user()->name }}</span></h2>
                    </li>
                </ul>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item nav-category">Student services</li>
                    <li class="nav-item">
